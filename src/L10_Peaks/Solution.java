 ...
 * that the first block (1, 2, 3, 4) has a peak at A[3], because A[2] < A[3] > A[4], even though A[4] is in the adjacent block.
 ...
 *
 * that, given a non-empty array A consisting of N integers, returns the maximum number of
 * blocks into which A can be divided.
 *
